    ...
    return {
        ...
        "data": {
            ...
            "user": {
                ...
                "department": user.department.name if user.department else "MoSPI",
                "cadre": user.cadre or "Indian Statistical Service (ISS)",
                "avatar": user.avatar or "",
                "role": role_str,
                "employeeId": user.employee_id,
                "overallCompetency": user.overall_competency or 0.0,
                "roleReadiness": user.role_readiness or 0.0,
                "criticalGapsCount": user.critical_gaps_count or 0,
                "learningHours": user.learning_hours or 0.0,
                "assessmentAverage": user.assessment_average or 0.0,
            },
        },
    }
