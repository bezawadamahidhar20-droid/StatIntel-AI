          ...
          return (
            ...
            >
              ...
              <div>
                ...
                {/* Evidence breakdown tags */}
                <div className="pt-2.5 pb-2 border-t border-slate-100 flex flex-wrap gap-1.5 text-[10px]">
                  <span className="px-2 py-0.5 rounded-md bg-slate-100 text-slate-700 font-medium flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3 text-emerald-600" />
                    Assessments ({Math.round(comp.currentScore * 0.95)}%)
                  </span>
                  <span className="px-2 py-0.5 rounded-md bg-slate-100 text-slate-700 font-medium flex items-center gap-1">
                ...
                <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                  <span className="flex items-center gap-1 font-medium text-[11px]">
                    ...
                    {comp.evidenceSources.length} verified audit sources
                  </span>
